...
class Finance extends React.Component {
  ...
  changeCompany = (company) => {
    if (
      this.state.selectedKonto.length > 0 ||
  ...
  changeKonto = (konto) => {
    if (
      this.state.selectedCompany.value !== undefined &&
      this.state.selectedCompany.value.length > 1
    ) {
      this.setState({
        selectedKonto: konto,
    ...
    return (
      <div>
        ...
        <div className="col-sm-12 height-styleFinance bck">
          <form
            name="checkForm"
            className="setOpacity banacecheckForm"
            ...
            <form name="detailsForm">
              <div className="form-group bananceDetailsForm">
                ...
                <input
                  ...
                  value={
                    this.state.balanceOutDetails !== undefined
                      ? parseFloat(
                          this.state.balanceOutDetails.duguje -
                            this.state.balanceOutDetails.potrazuje
                        ).toLocaleString()
                      : ""
                  }
                />
              ...
              <div className="form-group bananceDetailsForm">
                ...
                <input
                  ...
                  style={{ background: "white", fontWeight: "bold" }}
                  value={
                    this.state.balanceDetails !== undefined
                      ? parseFloat(
                          this.state.balanceDetails.duguje -
                            this.state.balanceDetails.potrazuje
                        ).toLocaleString()
                      : ""
                  }
                />
